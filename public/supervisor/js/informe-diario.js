        ...
        filteredDocs.forEach(docSnap => {
            ...
            listItem.innerHTML = `
                <div class="item-info">
                    ...
                    <span class="sector-badge inline-block font-bold text-[10px] bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded mr-2 uppercase tracking-wider">${sectorInfo}</span>
